const expcardcoll = document.getElementsByClassName('experience_card');
const expinfo = document.getElementsByClassName('exp_info')
...
const infolinks = [
    "https://drive.google.com/file/d/1gHxSQM_5_KDLp3VIMxYgQ7Fuitev2AAf/view?usp=sharing",
    "https://drive.google.com/file/d/13du4kinJgoiUzrQL-bte3RFjc5FcHVCV/view?usp=sharing"
]
...
for (let i = 0; i < expinfo.length; i++) {
    ...
    expinfo.item(i).addEventListener('click',() => {
        window.open(infolinks[i], '_blank');
    })
...
const extendagain = () => {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            expcardcoll[2].style.opacity = '1';
            expcardcoll[2].style.transition = 'opacity 0.5s ease';
        }, 1200);
    },1000);
...
const extend = () => {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            expcardcoll[1].style.opacity = '1';
            expcardcoll[1].style.transition = 'opacity 0.5s ease';
            //extendagain();
        },1200);
    },1000);
...
const begin = () => {
    ...
    if(screen.width <= 768)
    {
        ...
        expcardcoll[0].style.opacity = '1';
        expcardcoll[0].style.transition = 'opacity 0.5s ease';
